  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center relative overflow-auto">
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto px-4 py-4">
        ...
        {successMessage ? (
          <motion.div
            className="bg-white/90 backdrop-blur-sm rounded-lg shadow-lg p-6 md:p-8 mb-6 text-center"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5 }}
          >
        ...
        >
          {errorMessage && (
            <motion.div
              className="w-full rounded-lg bg-red-100 py-2 text-center text-lg font-semibold text-red-700"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            >
              {errorMessage}
