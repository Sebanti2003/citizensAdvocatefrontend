...
function GovtLogin() {
  ...
  if (loading) {
    return (
      <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#f7f3ea] px-4 py-8 text-slate-800">
        <style>{`
        ...
        <div className="relative text-lg font-medium">Loading...</div>
      </div>
    );
  }
