  ...
  useEffect(() => {
    const fetchEmployees = async () => {
      try {
        ...
        setEmployees(
          allEmployees.filter(
            (emp) => emp.department === "Ministry of Women and Child Development"
          )
        );
      } catch (error) {
        ...
        <div className="mb-6">
          ...
          {!showEmployeeView && isAssignMode && (
            <div className="mt-3 flex items-center gap-2">
              ...
              >
                <option value="">Select women & child employee</option>
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3 mb-5">
              <div>
                ...
                <p className="text-sm text-slate-500">
                  Women and child development employee information
                </p>
              </div>
            </div>
