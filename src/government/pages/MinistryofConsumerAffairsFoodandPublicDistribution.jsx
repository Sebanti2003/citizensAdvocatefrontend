...
import { FaTimes, FaPaperPlane, FaSignOutAlt } from "react-icons/fa";
...
console.log(selectedComplaint);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-green-100 p-6 md:p-12 flex flex-col items-center relative">
      {/* Logout Button */}
      <button onClick={handleLogout} className="absolute top-4 right-6 bg-red-600 text-white px-4 py-2 rounded-lg flex items-center gap-2 hover:bg-red-700">
        <FaSignOutAlt /> Logout
      </button>
