...
function MinistryofConsumerAffairs() {
  ...
  useEffect(() => {
    const syncComplaints = () => {
      const consumerComplaints = getAllComplaints().filter(
        (complaint) => complaint.ministry === "Consumer Affairs"
      );
      setComplaints(consumerComplaints);
    };
    ...
    const fetchEmployees = async () => {
      try {
        ...
        setEmployees(
          allEmployees.filter(
            (emp) =>
              emp.department === "Ministry of Consumer Affairs" ||
              emp.department ===
  ...
  return (
    <div className="min-h-screen flex bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-100">
      <div className="w-80 bg-gradient-to-b from-amber-900 via-orange-900 to-yellow-800 text-white shadow-2xl p-6">
        <div className="flex items-center gap-3 mb-8">
          <FaShoppingCart className="text-2xl text-yellow-300" />
          <h1 className="text-xl font-bold">Ministry of Consumer Affairs</h1>
        </div>
      ...
      <div className="flex-1 p-8">
        <div className="mb-6">
          ...
          <p className="text-gray-600">
            Monitor consumer complaints, fraud reports, and resolution workflow
          </p>
          ...
          {!showEmployeeView && isAssignMode && (
            <div className="mt-3 flex items-center gap-2">
              ...
              >
                <option value="">Select consumer affairs employee</option>
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3 mb-5">
              <div>
                ...
                <p className="text-sm text-slate-500">
                  Consumer affairs employee information
                </p>
              </div>
            </div>
        ...
        {!showEmployeeView && (
          <div className="grid gap-5">
            ...
            <motion.div
              ...
              className="bg-white rounded-2xl shadow-lg p-6 border-l-8 border-amber-500 cursor-pointer"
            >
            ...
            {!filtered.length && (
              <div className="bg-white rounded-2xl shadow p-6 text-gray-600">
                No consumer affairs complaints found.
              </div>
            )}
          </div>
        )}
